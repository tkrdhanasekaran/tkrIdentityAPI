...
namespace IdentityAPI.Controllers
{
    ...
    public class IdentityController : ControllerBase
    {
        ...
        public IdentityController(IdentityDbContext _db, IConfiguration _config)
        {
            this.db = _db;
            this.config = _config;
        }
        ...
        public async Task<ActionResult<dynamic>> Register(User user)
        {
             ...
             if (ModelState.IsValid)
            {
                ...
                await SendVerificationMailAync(user);
                return Created("", new
                {
                    user.Id,
                    user.Fullname,
        ...
        {
            //claim includes the information about the user
        ...
        [NonAction]
        private async Task SendVerificationMailAync(User user)
        {
            var userObj = new
            {
                user.Id,
